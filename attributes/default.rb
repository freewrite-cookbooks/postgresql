...
version_with_minor_component = /\./ === version ? version : "#{version}.0"
if Chef::VersionConstraint.new('< 9.3').include?(version_with_minor_component)
